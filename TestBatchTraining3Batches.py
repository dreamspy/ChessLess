...
#  model.add(Dropout(0.25, seed = 1337))
  ...
  model.compile(optimizer='rmsprop',
                ...
                metrics=['accuracy'])
  model.summary()
  model.fit(X_data1, Y_data1, batch_size=32, epochs=10, verbose=1)
  model.fit(X_data2, Y_data2, batch_size=32, epochs=10, verbose=1)
  model.fit(X_data3, Y_data3, batch_size=32, epochs=10, verbose=1)
...
X_data1, Y_data1 = loadData('data/lightning_e5_1.data')
X_data2, Y_data2 = loadData('data/lightning_e5_2.data')
X_data3, Y_data3 = loadData('data/lightning_e5_3.data')
X_test, Y_test = loadData('data/lightning_e5_4.data')
